...
class SecureStorage:
    ...
    def save_credential(target, username, password):
        ...
        try:
            ...
            AppLogger.log_error(f"[SecureStorage] Save Fail", e)
            return False
    ...
    def get_credential(target, username):
        ...
        try:
            ...
            AppLogger.log_error(f"[SecureStorage] Get Fail", e)
            return None
    ...
    def delete_credential(target, username):
        ...
        try:
            ...
            AppLogger.log_error(f"[SecureStorage] No Need Delete Credential", e)
            pass